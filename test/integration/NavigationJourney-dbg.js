sap.ui.define(["sap/ui/test/opaQunit", "./pages/AppPage", "./pages/StartPage", "sap/ui/test/Opa5"], function (opaTest, __AppPage, __ViewPage, Opa5) {
  "use strict";
  ...
  Opa5.extendConfig({
    viewNamespace: "apps.dflc.threecluesgame.view.",
    autoWait: true
  });
